...
import CreateUnitPage from './admin/CreateUnitPage';
...
export function Routes() {
    return (<Switch>
        ...
        <Route path="/admin/units/create" component={CreateUnitPage} />
        <Route path="/admin/units/:id" component={CreateUnitPage} />
